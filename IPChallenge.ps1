...
$IPAddress = $null
$IPAddress = '172.16.2.33/16'
$SubNet = '172.16.0.0/16'
Write-output "IP Address $IPAddress being tested against $SubNet"
If ((CheckSubnet $IPAddress $SubNet).Condition){
    Write-output "IP Address $IPAddress is in Subnet $SubNet"
}Else {
    Write-output "IP Address $IPAddress is NOT in Subnet $SubNet"
}

Write-output "----------------------------"

$IPAddress = $null
$IPAddress = '172.18.2.33/16'
$SubNet = '172.16.0.0/16'
Write-output "IP Address $IPAddress being tested against $SubNet"
If ((CheckSubnet $IPAddress $SubNet).Condition){
    Write-output "IP Address $IPAddress is in Subnet $SubNet"
